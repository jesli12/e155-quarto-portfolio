...
This is the first lab of the course, where students assemble and test the development pcb board that houses the MCU, FPGA, and various switches and buttons. The base hardware for the first half of the course 
is set up and tested here. 

Once functionally validated, a design was implemented on the FPGA 
...
The following report details the design and testing methodology of the lab project's implementation.
